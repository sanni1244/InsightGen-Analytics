...
<body>
  <div class="container">
    ...
    <button type="submit" class="btn" onclick="logout()"><a href="./blog_display.html">Log Out</a></button>

  </div>

  <script>
    $(document).ready(function () {
      var jsonFile = "blogs.json";
      ...
      $(".save-btn").on("click", function () {
        ...
        // Send the updated JSON data to the server-side script for saving
        $.ajax({
      ...
      // Delete selected object from JSON file
    ...
    function disablePageCache() {
      document.headers['Cache-Control'] = 'no-store, no-cache, must-revalidate, max-age=0';
      document.headers['Pragma'] = 'no-cache';
      document.headers['Expires'] = 'Thu, 01 Jan 1970 00:00:00 GMT';
    }
    disablePageCache();
